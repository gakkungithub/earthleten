    ...
    return (
        ...
        <ul className="flex bg-blue-600 mb-4 pl-2">
          <li className={`block px-4 py-2 my-1 hover:bg-gray-100 rounded ${pathname === '/' ? "bg-fuchsia-600" : ""}`}>
              ...
              ホーム</Link></li>
          <li className={`relative block text-blue-300 px-4 py-2 my-1 hover:bg-gray-100 rounded rounded-b-none ${pathname === '/threads' && "bg-fuchsia-600"}`}
          onMouseEnter={() => setShowThreadsMenu(true)} onMouseLeave={() => setShowThreadsMenu(false)}>
              ...
              {showThreadsMenu &&
                <ul className="absolute left-0 top-full">
                    ...
                    絞り込み</Link></li>
                    <li className={`block text-blue-300 px-4 py-2 bg-blue-600 hover:bg-gray-100 rounded rounded-t-none ${pathname === '/threads/add' && "bg-fuchsia-600"}`}>
